	...
	<nav aria-label="breadcrumb" class="d-none d-lg-block">
	  <ol class="breadcrumb bg-transparent p-0 {{ config('backpack.base.html_direction') == 'rtl' ? 'justify-content-start' : 'justify-content-end' }}">
		...
		<li class="breadcrumb-menu d-md-down-none">
            <div class="btn-group">
                <div class="dropdown">
                  <button class="btn dropdown-toggle" id="dropdownLangButton" type="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  ...
                  <div class="dropdown-menu" aria-labelledby="dropdownLangButton">
                    <a class="dropdown-item" href="{{ route('bp.set_lang', ['lang' => 'ru']) }}">RU</a>
                    <a class="dropdown-item" href="{{ route('bp.set_lang', ['lang' => 'en']) }}">EN</a>
                  </div>
                </div>
            </div>
		</li>
